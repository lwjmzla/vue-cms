      ...
      <div class="mui-card">
        <div class="mui-card-content">
          <div class="mui-card-content-inner">
            ...
            <mt-swipe :auto="4000" v-if="lunbotu.length">
              <mt-swipe-item v-for="(item,index) in lunbotu" :key="index">
                <img :src="item.src" class="lunbo_img" />
              </mt-swipe-item>
            </mt-swipe>
          </div>
        </div>
      ...
      <div class="mui-card">
        ...
        <div class="mui-card-content">
          <div class="mui-card-content-inner">
            ...
            <p>购买数量：<numbox @getcount="getSelectedCount" :max="goodsinfo.stock_quantity" ref="numbox"></numbox></p>
            <p>
...
// 导入 数字选择框 组件
import numbox from "components/goodsinfo_numbox.vue";
